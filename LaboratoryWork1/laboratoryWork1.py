...
timeRequired = round(1 / vFsand * (L1 + n * L2), 1)

print("Если спасатель начнёт движение под углом θ =", θ, "градусов, он достигнет утопащего через", timeRequired, "секунд.")